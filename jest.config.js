module.exports = {
  ...
  transformIgnorePatterns: [
    'node_modules/(?!(react-native|@react-native|@react-navigation|@react-native-community|nativewind|react-native-reanimated|react-redux|@reduxjs/toolkit|redux-persist)/)',
  ],
};
